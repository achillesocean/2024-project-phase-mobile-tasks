...
class ProductManager {
  ...
  void addProduct() {
    ...
    print('Thanks for adding a product');
  }
...
void main() {
  ...
  // Adding products
  productManager.addProduct(); // Add the first product
  productManager.addProduct(); // Add the second product
  productManager.addProduct(); // Add the third product
